...
class Parser
{
	...
	{
		$r_biding_url = ($page) ? static::$_bidding_url.'picsnum=50&select=bidding&apg='.$page : static::$_bidding_url;
	...
	{
		$r_won_url = ($page) ? static::$_won_url.'picsnum=50&select=won&apg='.$page : static::$_bidding_url;
